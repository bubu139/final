...
export const useAuth = () => {
  ...
  // Đây là phần chúng ta đã sửa cho 'useAuth'
  // if (!auth) {
...
export const useFirestore = () => {
  ...
  // --- BẮT ĐẦU SỬA LỖI ---
  // Tương tự, không ném lỗi ở đây.
  // Component (/test-history) sẽ tự xử lý khi firestore là null.
  // if (!firestore) {
  //   throw new Error('Firestore not initialized. Check FirebaseClientProvider.');
  // }
  // --- KẾT THÚC SỬA LỖI ---
  
  return firestore; // Chỉ cần trả về firestore (hoặc null)
};
